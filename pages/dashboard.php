        ...
        <div class="details" id="themes">
            <div class="box">
                <div class="">
                    ...
                    <form class="form" action="../includes/ajouterTheme.inc.php" method="post" enctype="application/x-www-form-urlencoded">
                        ...
                        <tbody style="text-align: center;">
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;"><a class="btn btn-info" href="./modifierTheme.php?id=<?php echo $row[0]; ?>">modifier</a>&nbsp;<a class="btn btn-danger" href="../includes/deleteTheme.inc.php?id=<?php echo $row[0]; ?>">supprimer</a>
                                    </td>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    ...
                                    <?php echo "../uploads/" . $row['imageTheme']; ?>
